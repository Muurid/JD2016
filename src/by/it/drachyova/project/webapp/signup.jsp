...
<form class="form-horizontal" action="do?command=SIGNUP" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="login" name="Login" type="text" value="UserLogin" placeholder=""
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="password" name="Password" type="password" value="UserPassword" placeholder=""
                       class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="email" name="Email" type="text" value="email@gmail.com" placeholder=""
                       class="form-control input-md" required="">
