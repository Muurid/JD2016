...
<form class="form-horizontal" action="do?command=CREATERESERVATION" method="POST">
    <fieldset>

        <!-- Form Name -->
        <legend>Заказать номер</legend>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="Address" name="Address" type="text" placeholder="" value="TEST: ул. Ленина, д.1, кв.1"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea class="form-control" id="Description"
                          name="Description">TEST: Квартира в самом центре</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="Area" name="Area" type="text" placeholder="" value="45" class="form-control input-md"
                       required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="Price" name="Price" type="text" placeholder="" value="60" class="form-control input-md"
                       required="">
